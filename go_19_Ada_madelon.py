...
ProblemLabels = "madelon_labels"
ProblemData = "madelon_data"
Lambda1 = 0.001
ITE_MAX = 10
Debug = True
...
if rank == 0:
    MasterLabels = "./data/" + ProblemLabels + ".dat"
    MasterData = "./data/" + ProblemData + ".dat"
else:
    SlaveLabels = "./data/slaves/" + ProblemLabels + "_worker_" + str(rank) + ".dat"
    SlaveData = "./data/slaves/" + ProblemData + "_worker_" + str(rank) + ".dat"
...
if rank == 0:
    StartTime = time.time()
    X =  open("./output/X_CATA_Ada_madelon.dat", 'r')
    Y =  open("./output/Y_CATA_Ada_madelon.dat", 'r')
    k = 0
